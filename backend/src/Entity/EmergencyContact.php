...
class EmergencyContact
{
    ...
    #[ORM\ManyToOne(targetEntity: Device::class, inversedBy: 'contacts')]
    ...
    #[ORM\Column(name: 'phone_ciphertext', type: 'text')]
    private string $phoneCiphertext;

    #[ORM\Column(name: 'phone_hash', length: 64)]
    private string $phoneHash;

    #[ORM\Column(name: 'phone_last4', length: 4)]
