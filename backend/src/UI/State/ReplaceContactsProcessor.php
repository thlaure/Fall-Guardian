...
use App\Application\Contact\DTO\ContactInput;
use App\Application\Contact\DTO\ReplaceContactsInput;
use App\Application\Contact\DTO\ReplaceContactsOutput;
use App\Application\Contact\Handler\ContactSyncService;
...
final readonly class ReplaceContactsProcessor implements ProcessorInterface
{
    ...
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): ReplaceContactsOutput
    {
        ...
        $storedContacts = $this->contactSyncService->replaceContacts(
            ...
            array_map($this->normalizeContact(...), $data->contacts),
        );
