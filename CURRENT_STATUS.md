...
- The caregiver app now exists only as a separate scaffold. The real caregiver workflow is still not implemented.
...
- Caregiver app: separate Flutter app scaffolded, but not yet connected to alert delivery.
