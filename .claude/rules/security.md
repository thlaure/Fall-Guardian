...
- Prefer fixing PHPStan findings in code, types, or PHPDoc rather than adding ignores or broadening config.
- Treat phone/watch/backend cross-device messages as untrusted input until validated.
