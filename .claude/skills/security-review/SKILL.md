...
description: Use this skill when the user asks for a security review, mentions auth/authz concerns, input validation, secret handling, SSRF, unsafe external calls, or wants a stricter review of a Fall Guardian change.
---
...
3. Check secrets, outbound calls, platform-channel boundaries, and user-controlled remote targets.
